"""Modal B200 Nsight Systems launcher for the b1n16384 Cholesky variants.
...
LOCAL_SOLUTION = "cholesky/b1n16384/cholesky_b1n16384.py"
LOCAL_SCRIPT = "cholesky/b1n16384/cholesky_b1n16384_modal.py"
REMOTE_SOLUTION = "/workspace/cholesky_b1n16384.py"
REMOTE_SCRIPT = "/workspace/cholesky_b1n16384_modal.py"
...
app = modal.App("cholesky-b1n16384-nsys-b200", image=nsys_image)
cache_volume = modal.Volume.from_name(
    "cholesky-b1n16384-cache", create_if_missing=True
)
...
def main(variant: int = -1, output: str = "") -> None:
    ...
    output_root = (
        Path(output)
        if output
        else _repo_root() / "cholesky/b1n16384/artifacts/nsys"
    )
