"""Modal B200 Nsight Systems launcher for the b16n512 Cholesky variants.
...
LOCAL_SOLUTION = "cholesky/b16n512/cholesky_b16n512.py"
LOCAL_SCRIPT = "cholesky/b16n512/cholesky_b16n512_modal.py"
REMOTE_SOLUTION = "/workspace/cholesky_b16n512.py"
REMOTE_SCRIPT = "/workspace/cholesky_b16n512_modal.py"
...
app = modal.App("cholesky-b16n512-nsys-b200", image=nsys_image)
cache_volume = modal.Volume.from_name(
    "cholesky-b16n512-cache", create_if_missing=True
)
...
def main(variant: int = -1, output: str = "") -> None:
    ...
    output_root = (
        Path(output)
        if output
        else _repo_root() / "cholesky/b16n512/artifacts/nsys"
    )
