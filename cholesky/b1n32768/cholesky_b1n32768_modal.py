"""Modal B200 Nsight Systems launcher for the b1n32768 Cholesky variants.
...
LOCAL_SOLUTION = "cholesky/b1n32768/cholesky_b1n32768.py"
LOCAL_SCRIPT = "cholesky/b1n32768/cholesky_b1n32768_modal.py"
REMOTE_SOLUTION = "/workspace/cholesky_b1n32768.py"
REMOTE_SCRIPT = "/workspace/cholesky_b1n32768_modal.py"
...
app = modal.App("cholesky-b1n32768-nsys-b200", image=nsys_image)
cache_volume = modal.Volume.from_name(
    "cholesky-b1n32768-cache", create_if_missing=True
)
...
def main(
    ...
    output_root = (
        Path(output)
        if output
        else _repo_root() / "cholesky/b1n32768/artifacts/nsys"
    )
