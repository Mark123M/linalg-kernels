"""Modal B200 Nsight Systems launcher for the b2n4096 Cholesky variants.

Examples:
    .venv/bin/python -m modal run cholesky/b2n4096/cholesky_b2n4096_modal.py
    .venv/bin/python -m modal run cholesky/b2n4096/cholesky_b2n4096_modal.py --variant 5
    .venv/bin/python -m modal run cholesky/b2n4096/cholesky_b2n4096_modal.py \
...
LOCAL_SOLUTION = "cholesky/b2n4096/cholesky_b2n4096.py"
LOCAL_SCRIPT = "cholesky/b2n4096/cholesky_b2n4096_modal.py"
REMOTE_SOLUTION = "/workspace/cholesky_b2n4096.py"
REMOTE_SCRIPT = "/workspace/cholesky_b2n4096_modal.py"
...
app = modal.App("cholesky-b2n4096-nsys-b200", image=nsys_image)
cache_volume = modal.Volume.from_name(
    "cholesky-b2n4096-cache", create_if_missing=True
)
...
def main(
    ...
    if validate:
        ...
        output_root = (
            Path(output)
            if output
            else _repo_root() / "cholesky/b2n4096/artifacts/validation"
        )
    ...
    output_root = (
        Path(output)
        if output
        else _repo_root() / "cholesky/b2n4096/artifacts/nsys"
    )
