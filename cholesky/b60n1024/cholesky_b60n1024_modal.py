"""Modal B200 Nsight Systems launcher for the b60n1024 Cholesky variants.
...
LOCAL_SOLUTION = "cholesky/b60n1024/cholesky_b60n1024.py"
LOCAL_SCRIPT = "cholesky/b60n1024/cholesky_b60n1024_modal.py"
REMOTE_SOLUTION = "/workspace/cholesky_b60n1024.py"
REMOTE_SCRIPT = "/workspace/cholesky_b60n1024_modal.py"
...
app = modal.App("cholesky-b60n1024-nsys-b200", image=nsys_image)
cache_volume = modal.Volume.from_name(
    "cholesky-b60n1024-cache", create_if_missing=True
)
...
def main(variant: int = -1, output: str = "") -> None:
    ...
    output_root = (
        Path(output)
        if output
        else _repo_root() / "cholesky/b60n1024/artifacts/nsys"
    )
